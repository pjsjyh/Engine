...
namespace so {
	...
	void Animator::CreateAnimation(const std::wstring& name, graphics::Texture* spritesSheet, Vector2 leftTop, Vector2 size, Vector2 offset, UINT spriteLength, float duration)
	{
		...
		Events* evets = new Events();
		mEvents.insert(std::make_pair(name, evets));
